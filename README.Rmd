...
This repository is designed as an example modeling Hub that follows the infrastructure guidelines laid out by the [hubverse](https://hubverse.io).
...
To work with the data in R, you can install the [latest version of hubData from the R-universe](https://hubverse-org.r-universe.dev/hubData):
